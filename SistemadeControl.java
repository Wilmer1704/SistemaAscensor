class SistemaControl {
    ...
    public SistemaControl(int totalPisos) {
        ...
        this.pisos= new Piso[totalPisos]; // Crea el arreglo de pisos (5 pisos)
    ...
    public void registrarAlerta(String mensaje, String tipo) {
        if (totalAlertas < alertas.length) {  // Verifica espacio en el arreglo
            ...
            System.out.println(" No se pueden registrar mas alertas.");
        }
    }
    ...
    public void mostrarEstadoSistema() {
        ...
        }    // recorre el numero de pisos y muestra el estado de cada puerta
    ...
    public void generarReporte() {
        ...
        System.out.println(" Direccion      : " + ascensor.getDireccion()); // subida, bajada, detenido
